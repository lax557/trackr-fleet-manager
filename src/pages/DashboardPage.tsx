...
export function DashboardPage() {
  ...
  const financialKpis = execMetrics ? [
    { label: 'Receita Estimada', value: formatCurrencyBRL(execMetrics.estimatedMonthlyRevenue), icon: DollarSign, colorClass: 'text-green-600', tooltip: 'Receita mensal estimada: pró-rata de entrada (se não segunda) + cobranças semanais nas segundas do mês' },
